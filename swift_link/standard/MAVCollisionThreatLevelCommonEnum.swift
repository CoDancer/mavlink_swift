...
extension MAVCollisionThreatLevel: Enumeration {
    ...
    public static var membersDescriptions = [("MAV_COLLISION_THREAT_LEVEL_NONE", "Not a threat"), ("MAV_COLLISION_THREAT_LEVEL_LOW", "Craft is mildly concerned about this threat"), ("MAV_COLLISION_THREAT_LEVEL_HIGH", "Craft is panicking, and may take actions to avoid threat")]
