...
public enum MAVSysStatusSensor: UInt32 {
	...
	/// 0x2000000 Battery
	case battery = 33554432

	/// 0x4000000 Proximity
	case proximity = 67108864

	/// 0x8000000 Satellite Communication
	case satcom = 134217728
}
