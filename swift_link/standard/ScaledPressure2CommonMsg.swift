...
extension ScaledPressure2: Message {
    ...
    public static var fieldDefinitions: [FieldDefinition] = [("timeBootMs", 0, "UInt32", 0, "Timestamp (time since system boot)."), ("pressAbs", 4, "Float", 0, "Absolute pressure"), ("pressDiff", 8, "Float", 0, "Differential pressure"), ("temperature", 12, "Int16", 0, "Temperature measurement")]
