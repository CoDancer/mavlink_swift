...
extension NamedValueInt: Message {
    ...
    public static var fieldDefinitions: [FieldDefinition] = [("timeBootMs", 0, "UInt32", 0, "Timestamp (time since system boot)."), ("name", 8, "String", 10, "Name of the debug variable"), ("value", 4, "Int32", 0, "Signed integer value")]
