...
extension MissionRequestPartialList: Message {
    ...
    public static var typeDescription = "Request a partial list of mission items from the system/component. https://mavlink.io/en/services/mission.html. If start and end index are the same, just send one waypoint."
    public static var fieldDefinitions: [FieldDefinition] = [("targetSystem", 4, "UInt8", 0, "System ID"), ("targetComponent", 5, "UInt8", 0, "Component ID"), ("startIndex", 0, "Int16", 0, "Start index"), ("endIndex", 2, "Int16", 0, "End index, -1 by default (-1: send list to end). Else a valid index of the list")]
