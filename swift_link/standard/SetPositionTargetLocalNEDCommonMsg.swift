//
//  SetPositionTargetLocalNEDCommonMsg.swift
...
public struct SetPositionTargetLocalNED {
...
extension SetPositionTargetLocalNED: Message {
    public static let id = UInt8(84)
    public static var typeName = "SET_POSITION_TARGET_LOCAL_NED"
    public static var typeDescription = "Sets a desired vehicle position in a local north-east-down coordinate frame. Used by an external controller to command the vehicle (manual controller or other system)."
    public static var fieldDefinitions: [FieldDefinition] = [("timeBootMs", 0, "UInt32", 0, "Timestamp (time since system boot)."), ("targetSystem", 50, "UInt8", 0, "System ID"), ("targetComponent", 51, "UInt8", 0, "Component ID"), ("coordinateFrame", 52, "MAVFrame", 0, "Valid options are: MAV_FRAME_LOCAL_NED = 1, MAV_FRAME_LOCAL_OFFSET_NED = 7, MAV_FRAME_BODY_NED = 8, MAV_FRAME_BODY_OFFSET_NED = 9"), ("typeMask", 48, "PositionTargetTypemask", 0, "Bitmap to indicate which dimensions should be ignored by the vehicle."), ("x", 4, "Float", 0, "X Position in NED frame"), ("y", 8, "Float", 0, "Y Position in NED frame"), ("z", 12, "Float", 0, "Z Position in NED frame (note, altitude is negative in NED)"), ("vx", 16, "Float", 0, "X velocity in NED frame"), ("vy", 20, "Float", 0, "Y velocity in NED frame"), ("vz", 24, "Float", 0, "Z velocity in NED frame"), ("afx", 28, "Float", 0, "X acceleration or force (if bit 10 of type_mask is set) in NED frame in meter / s^2 or N"), ("afy", 32, "Float", 0, "Y acceleration or force (if bit 10 of type_mask is set) in NED frame in meter / s^2 or N"), ("afz", 36, "Float", 0, "Z acceleration or force (if bit 10 of type_mask is set) in NED frame in meter / s^2 or N"), ("yaw", 40, "Float", 0, "yaw setpoint"), ("yawRate", 44, "Float", 0, "yaw rate setpoint")]
