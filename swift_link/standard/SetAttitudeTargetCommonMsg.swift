//
//  SetAttitudeTargetCommonMsg.swift
...
extension SetAttitudeTarget: Message {
    ...
    public static var fieldDefinitions: [FieldDefinition] = [("timeBootMs", 0, "UInt32", 0, "Timestamp (time since system boot)."), ("targetSystem", 36, "UInt8", 0, "System ID"), ("targetComponent", 37, "UInt8", 0, "Component ID"), ("typeMask", 38, "UInt8", 0, "Mappings: If any of these bits are set, the corresponding input should be ignored: bit 1: body roll rate, bit 2: body pitch rate, bit 3: body yaw rate. bit 4-bit 6: reserved, bit 7: throttle, bit 8: attitude"), ("q", 4, "[Float]", 4, "Attitude quaternion (w, x, y, z order, zero-rotation is 1, 0, 0, 0)"), ("bodyRollRate", 20, "Float", 0, "Body roll rate"), ("bodyPitchRate", 24, "Float", 0, "Body pitch rate"), ("bodyYawRate", 28, "Float", 0, "Body yaw rate"), ("thrust", 32, "Float", 0, "Collective thrust, normalized to 0 .. 1 (-1 .. 1 for vehicles capable of reverse trust)")]
