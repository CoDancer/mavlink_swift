...
extension GlobalVisionPositionEstimate: Message {
    ...
    public static var typeDescription = "Global position/attitude estimate from a vision source."
    public static var fieldDefinitions: [FieldDefinition] = [("usec", 0, "UInt64", 0, "Timestamp (UNIX time or since system boot)"), ("x", 8, "Float", 0, "Global X position"), ("y", 12, "Float", 0, "Global Y position"), ("z", 16, "Float", 0, "Global Z position"), ("roll", 20, "Float", 0, "Roll angle"), ("pitch", 24, "Float", 0, "Pitch angle"), ("yaw", 28, "Float", 0, "Yaw angle")]
