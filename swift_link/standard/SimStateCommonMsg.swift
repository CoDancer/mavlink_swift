...
extension SimState: Message {
    ...
    public static var fieldDefinitions: [FieldDefinition] = [("q1", 0, "Float", 0, "True attitude quaternion component 1, w (1 in null-rotation)"), ("q2", 4, "Float", 0, "True attitude quaternion component 2, x (0 in null-rotation)"), ("q3", 8, "Float", 0, "True attitude quaternion component 3, y (0 in null-rotation)"), ("q4", 12, "Float", 0, "True attitude quaternion component 4, z (0 in null-rotation)"), ("roll", 16, "Float", 0, "Attitude roll expressed as Euler angles, not recommended except for human-readable outputs"), ("pitch", 20, "Float", 0, "Attitude pitch expressed as Euler angles, not recommended except for human-readable outputs"), ("yaw", 24, "Float", 0, "Attitude yaw expressed as Euler angles, not recommended except for human-readable outputs"), ("xacc", 28, "Float", 0, "X acceleration"), ("yacc", 32, "Float", 0, "Y acceleration"), ("zacc", 36, "Float", 0, "Z acceleration"), ("xgyro", 40, "Float", 0, "Angular speed around X axis"), ("ygyro", 44, "Float", 0, "Angular speed around Y axis"), ("zgyro", 48, "Float", 0, "Angular speed around Z axis"), ("lat", 52, "Float", 0, "Latitude"), ("lon", 56, "Float", 0, "Longitude"), ("alt", 60, "Float", 0, "Altitude"), ("stdDevHorz", 64, "Float", 0, "Horizontal position standard deviation"), ("stdDevVert", 68, "Float", 0, "Vertical position standard deviation"), ("vn", 72, "Float", 0, "True velocity in NORTH direction in earth-fixed NED frame"), ("ve", 76, "Float", 0, "True velocity in EAST direction in earth-fixed NED frame"), ("vd", 80, "Float", 0, "True velocity in DOWN direction in earth-fixed NED frame")]
