...
extension MissionRequest: Message {
    public static let id = UInt8(40)
    public static var typeName = "MISSION_REQUEST"
    public static var typeDescription = "Request the information of the mission item with the sequence number seq. The response of the system to this message should be a MISSION_ITEM message. https://mavlink.io/en/services/mission.html"
