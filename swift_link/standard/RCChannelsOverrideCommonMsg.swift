//
//  RCChannelsOverrideCommonMsg.swift
...
extension RCChannelsOverride: Message {
    ...
    public static var fieldDefinitions: [FieldDefinition] = [("targetSystem", 16, "UInt8", 0, "System ID"), ("targetComponent", 17, "UInt8", 0, "Component ID"), ("chan1Raw", 0, "UInt16", 0, "RC channel 1 value. A value of UINT16_MAX means to ignore this field."), ("chan2Raw", 2, "UInt16", 0, "RC channel 2 value. A value of UINT16_MAX means to ignore this field."), ("chan3Raw", 4, "UInt16", 0, "RC channel 3 value. A value of UINT16_MAX means to ignore this field."), ("chan4Raw", 6, "UInt16", 0, "RC channel 4 value. A value of UINT16_MAX means to ignore this field."), ("chan5Raw", 8, "UInt16", 0, "RC channel 5 value. A value of UINT16_MAX means to ignore this field."), ("chan6Raw", 10, "UInt16", 0, "RC channel 6 value. A value of UINT16_MAX means to ignore this field."), ("chan7Raw", 12, "UInt16", 0, "RC channel 7 value. A value of UINT16_MAX means to ignore this field."), ("chan8Raw", 14, "UInt16", 0, "RC channel 8 value. A value of UINT16_MAX means to ignore this field.")]
