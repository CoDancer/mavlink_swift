...
extension LocalPositionNEDSystemGlobalOffset: Message {
    ...
    public static var fieldDefinitions: [FieldDefinition] = [("timeBootMs", 0, "UInt32", 0, "Timestamp (time since system boot)."), ("x", 4, "Float", 0, "X Position"), ("y", 8, "Float", 0, "Y Position"), ("z", 12, "Float", 0, "Z Position"), ("roll", 16, "Float", 0, "Roll"), ("pitch", 20, "Float", 0, "Pitch"), ("yaw", 24, "Float", 0, "Yaw")]
