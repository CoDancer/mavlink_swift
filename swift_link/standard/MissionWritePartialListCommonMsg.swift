//
//  MissionWritePartialListCommonMsg.swift
...
extension MissionWritePartialList: Message {
    ...
    public static var fieldDefinitions: [FieldDefinition] = [("targetSystem", 4, "UInt8", 0, "System ID"), ("targetComponent", 5, "UInt8", 0, "Component ID"), ("startIndex", 0, "Int16", 0, "Start index. Must be smaller / equal to the largest index of the current onboard list."), ("endIndex", 2, "Int16", 0, "End index, equal or greater than start index.")]
